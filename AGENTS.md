...
- **Movement**: grid-snapped, wall-aware (segment intersection), respects `grid.diagonal` setting (1.5x cost when `diagonal === 1`). Supports Foundry v14 elevation thresholds and Levels module wall elevation flags.
